...
opc01 = genera_opciones(pobl, resultado, numerator1, valores[3])
opc02 = genera_opciones(pobl, resultado2, numerator2, valores[1])
opc03 = genera_opciones(pobl, resultado3, numerator3, valores[0])
...
I. `r py$claves[1]` `r py$valores[3]`\
II. `r py$claves[2]` `r py$valores[2]`\
III. `r py$claves[3]` `r py$valores[4]`\
IV. `r py$claves[4]` `r py$valores[1]`\
...
La afirmación CORRECTA es: "II. `r py$claves[2]` `r py$valores[2]`"\


Meta-information
================

exname: CND10S223-46_v02_opB_tiB(single-choice)
extype: schoice
exsolution: 0100
exshuffle: FALSE