## exams ----------------------------------------------------------------------------
setwd("/media/datascience/Bodega/Nubes/2023/Rexams2023/Repositorio/schoice/Schioce_2023/Schoice2023/Saber2023Matematicas/Por Temas/Combinatorias/07-CombinacionSinRepeticion")
library(exams)
library(ggplot2)
library(ggrepel)
library(tidyverse)
...
examen01 <- c("CombinacionSinRep_01_05.Rmd")
...
#-----------------------------------
set.seed(semilla)
exams2moodle(examen01,n=40,svg=TRUE,name="CombinacionSinRep_01_05",encoding="UTF-8",
...
# set.seed(semilla)
# exams2moodle(examen01,n=30,svg=TRUE,name="CSR_01_01",encoding="UTF-8",
