...
\usepackage{rawfonts,fancyhdr,txfonts,pxfonts}
\usepackage{pictexwd}
\usepackage{tikz}
\usepackage{tkz-euclide}
\usepackage{pgfplots}
\usepackage{a4wide,color,verbatim,Sweave,url,xargs,amsmath,hyperref,tabu,multicol,pgfplots,graphicx,booktabs}
...
\usepackage{floatrow}
\usetikzlibrary{calc,intersections,through,backgrounds,spy,snakes}
\usetikzlibrary{shapes,arrows, chains, matrix, calc, trees, positioning, fit}
\pgfplotsset{compat=newest}

%% new environments
\newenvironment{question}{\item \textbf{Escenario}\newline}{}
\newenvironment{solution}{\textbf{Análisis de la opción correcta}\newline}{}
