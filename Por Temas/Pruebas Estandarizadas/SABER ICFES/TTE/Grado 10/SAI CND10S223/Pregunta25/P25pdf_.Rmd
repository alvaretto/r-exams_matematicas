...
correcta <- carga1 * trapo_det2 + carga2 * trapo_det3
distractor2 <- carga1 * trapo_det1 + carga2 * trapo_det2
distractor3 <- carga2 * trapo_det2 + carga3 * trapo_det3
distractor4 <- carga1 * trapo_det1 + carga5 * trapo_det5

if(correcta != distractor2 && tot_gramos == distractor2 && tot_gramos == distractor3 && tot_gramos == distractor4) {
  contador <- contador + 1
} else {
  contador <- 0
}
...
ropa. Esto es incorrecto, si se lavan:

Answerlist
----------

- `r carga1` carga(s) en el programa `r carga_ropa2` y `r carga2` carga(s) en el 
programa `r carga_ropa3`.
<br/> 
...
- `r carga2` carga(s) en el programa `r carga_ropa2` y `r carga3` carga(s) en el 
programa `r carga_ropa3`.
<br/> 

- `r carga1` carga(s) en el programa `r carga_ropa1` y `r carga5` carga(s) en el 
programa `r carga_ropa5`.
<br/> 
