## exams ----------------------------------------------------------------------------
setwd("/media/datascience/Bodega/Nubes/2023/Rexams2023/Repositorio/schoice/Schioce_2023/Schoice2023/Saber2023Matematicas/Por Temas/MedidasDeTendenciaCentral/MediaMedianaModaEnTablaDeFrecuencias")
library(exams)
library(xtable)
library(reticulate)
require(stats)
...
################################################################
set.seed(semilla)
exams2pdf(examen01,name="Percentiles_",encoding="UTF-8",n=1,
...
#########################################################################
set.seed(semilla)
exams2pandoc(examen01, name="MeMedModa_py__",template = "plain.tex",n=1,
...
exams2moodle(examen01,n=1,svg=TRUE,name="MeMedModa_py_2",encoding="UTF-8",
             dir="salida",edir="ejercicios",
             mchoice = list(shuffle = TRUE,answernumbering = "ABCD",
                            eval = list(partial = TRUE,rule = "none")))
####################################################################
set.seed(semilla)
exams2pdf(examen01,name="MeMedModa_py_", encoding="UTF-8",n=1,
