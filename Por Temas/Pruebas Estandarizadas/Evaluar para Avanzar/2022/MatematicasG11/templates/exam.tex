...
%% headings
\markboth{\textnormal{\bf \large Combinatorias: \myID}}%
{\textnormal{\bf \large Combinatorias: \myID}}
...
\thispagestyle{empty}
{\sf
\textbf{\LARGE{I. E. Pedacito de Cielo}}

\textbf{\large{Combinatorias \myDate \hfill Evaluación \myID}}

\vspace*{2cm}

\begin{tabular}{p{14cm}}
\textbf{Apellidos y Nombres:} \hrule \\[1.5cm]
\textbf{Número de Documento:} \hrule \\[1.5cm]
