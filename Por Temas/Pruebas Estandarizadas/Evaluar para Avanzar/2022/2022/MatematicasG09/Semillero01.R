## exams ----------------------------------------------------------------------------
setwd("~/Insync/alvaroangelm@iepedacitodecielo.edu.co/Google Drive/2023/Rexams2023/Repositorio/schoice/Schoice_2023/Schoice2023/PorTemas/Pruebas Estandarizadas/Evaluar para Avanzar/2022/2022/MatematicasG09")
library(exams)
library(ggplot2)
library(ggrepel)
...
copias <- 180
qqq <- rep("15_C01_G09_2022_TipoB2.Rmd",1)
...
################################################################################
set.seed(semilla)
exams2moodle(examen01,n=copias,svg=TRUE,name="15_C01_G09_2022_TipoB2",encoding="UTF-8",
             dir="salida",edir="ejercicios", mchoice = list(shuffle = TRUE,
