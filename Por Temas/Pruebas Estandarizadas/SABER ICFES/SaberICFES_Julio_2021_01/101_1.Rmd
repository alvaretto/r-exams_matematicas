...
solcorr <- preciodifmin
solerr2 <- sample(c(preciodifmin+10,preciodifmin-10),1)
solerr3 <- minuplanlocal
solerr4 <- sample(c(preciodifmin/2,preciodifmin*1.5),1)


questions<-solutions<-explanations<-NULL
questions[1]<-paste("$", solerr2, "")
solutions[1]<-FALSE
explanations[1]<-"."

questions[2]<-paste("$", solerr3, "")
solutions[2]<-FALSE
explanations[2]<-"."

questions[3]<-paste("$", preciodifmin, "")
solutions[3]<-TRUE
explanations[3]<-"."

questions[4]<-paste("$", solerr4, "")
solutions[4]<-FALSE
explanations[4]<-"."
...
El señor `r familia` considera que el valor del minuto adicional del mes de enero fue excesivo. 
...
\
La hija del señor `r familia` asegura que la diferencia entre el valor del minuto del plan y el valor del minuto adicional es de
\
