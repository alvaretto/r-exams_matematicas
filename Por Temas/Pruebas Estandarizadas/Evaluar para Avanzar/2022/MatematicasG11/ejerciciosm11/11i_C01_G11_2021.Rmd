...
========
\
Dado que la encuesta se realizó a `r clientes` clientes, y el `r porcentaje[4]` % de los encuestados calificó como “excelente” el servicio, entonces $\frac{`r porcentaje[4]`}{100}$ × `r clientes` clientes = `r exce` clientes calificaron como “excelente” el servicio. Por tanto, la afirmación incorrecta acerca de los resultados de la encuesta es: "Más de `r exce2` clientes consideran que la calidad del servicio que ofrece la empresa es excelente".
