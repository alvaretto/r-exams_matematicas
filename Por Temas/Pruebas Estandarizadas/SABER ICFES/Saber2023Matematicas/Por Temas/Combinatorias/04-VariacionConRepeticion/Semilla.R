## exams ----------------------------------------------------------------------------
setwd("/media/datascience/Bodega/Nubes/2023/Rexams2023/Repositorio/schoice/Schioce_2023/Schoice2023/Saber2023Matematicas/Por Temas/Combinatorias/04-VariacionConRepeticion")
library(exams)
library(ggplot2)
library(ggrepel)
library(tidyverse)
...
examen01 <- c("VariacionConRep_01_05_py.Rmd")
...
#-----------------------------------
set.seed(semilla)
exams2moodle(examen01,n=40,svg=TRUE,name="VariacionConRep_01_05_py",encoding="UTF-8",
