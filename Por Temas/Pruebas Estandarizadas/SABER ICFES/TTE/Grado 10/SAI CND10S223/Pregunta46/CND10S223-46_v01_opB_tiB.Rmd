...
I. `r claves[2]` `r valores[5]`\
II. `r claves[1]` `r valores[1]`\
III. `r claves[3]` `r valores[6]`\
...
- 
La expresión I, `r opc02` `r valores[5]`

- 
La expresión II, `r opc01` `r valores[1]`

- 
La expresión III, `r opc03` `r valores[6]`
...
La afirmación CORRECTA es: "II. `r claves[1]` `r valores[1]`"\


Meta-information
================

exname: CND10S223-46_v01_opB_tiB(single-choice)
extype: schoice
exsolution: 0100
exshuffle: FALSE