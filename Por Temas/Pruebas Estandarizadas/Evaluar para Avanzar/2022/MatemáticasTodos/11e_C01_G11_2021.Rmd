...
Además, $\frac{`r porcentaje6`}{100}$ × `r clientes` clientes = `r regu_malo` clientes calificaron como “insatisfactorio” el servicio. Por tanto, es verdadero que menos de `r regu_malo2` clientes están insatisfechos con el servicio que ofrece la empresa.
