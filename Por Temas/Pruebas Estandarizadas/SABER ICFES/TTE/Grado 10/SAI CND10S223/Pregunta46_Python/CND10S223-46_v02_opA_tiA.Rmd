...
use_python("~/miniconda3/envs/nuevoRstudio/bin/python3.11", required = TRUE)
options(scipen=999)
...
ninos1 = np.random.choice(range(10, 41), 9, replace=False)
...
I. `r py$claves[1]` `r py$valores[5]`\
...
La afirmación INCORRECTA es: "I. `r py$claves[1]` `r py$valores[5]`"\


Meta-information
================

exname: CND10S223-46_v02_opA_tiA(single-choice)
extype: schoice
exsolution: 1000
exshuffle: FALSE