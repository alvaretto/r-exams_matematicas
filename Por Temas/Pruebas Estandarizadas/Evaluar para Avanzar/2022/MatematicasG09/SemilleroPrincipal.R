## exams ----------------------------------------------------------------------------
setwd("~/Insync/alvaroangelm@iepedacitodecielo.edu.co/Google Drive/2023/Rexams2023/Repositorio/schoice/Schoice_2023/2023_Repo/r-exams_matematicas/r-exams_matematicas/Por Temas/Pruebas Estandarizadas/Evaluar para Avanzar/2022/MatematicasG09")
library(exams)
library(ggplot2)
library(ggrepel)
...
copias <- 1
qqq <- rep("15_C01_G09_2022_TipoA1.Rmd",10)
...
# ####################################################################
set.seed(semilla)
exams2pdf(examen01,name="15_C01_G09_2022_TipoA1_", encoding="UTF-8",n=copias,
