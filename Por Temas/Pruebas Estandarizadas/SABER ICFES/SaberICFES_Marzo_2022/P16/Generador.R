## exams ----------------------------------------------------------------------------
setwd("~/Insync/alvaroangelm@iepedacitodecielo.edu.co/Google Drive/2023/Rexams2023/Repositorio/schoice/Schoice_2023/Schoice2023/PorTemas/Pruebas Estandarizadas/SABER ICFES/SaberICFES_Marzo_2022/P16")
## load package
library(exams)
library(tinytex)
...
###################################################################
set.seed(semilla)
exams2moodle(examen01, n = 200, svg = TRUE, name = "P16_01_", encoding = "UTF-8",
