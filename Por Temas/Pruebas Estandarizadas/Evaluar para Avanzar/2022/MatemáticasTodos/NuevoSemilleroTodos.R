## exams ----------------------------------------------------------------------------
setwd("/media/datascience/Bodega/Nubes/2023/Rexams2023/Repositorio/schoice/Schioce_2023/Schoice2023/PorTemas/Evaluar para Avanzar/2022/MatemáticasTodos")
library(ggplot2)
library(reticulate)
