...
I. `r claves[3]` `r valores[6]`\
II. `r claves[2]` `r valores[5]`\
III. `r claves[1]` `r valores[1]`\
IV. `r claves[4]` `r valores[7]`\
...
- 
La expresión I, `r opc03` `r valores[6]`

- 
La expresión II, `r opc02` `r valores[5]`

- 
La expresión III, `r opc01` `r valores[1]`

- 
La expresión IV, `r opc04` `r valores[7]`


Solution
========

La afirmación CORRECTA es: "III. `r claves[1]` `r valores[1]`"\


Meta-information
================

exname: CND10S223-46_v01_opC_tiB(single-choice)
extype: schoice
exsolution: 0010
exshuffle: FALSE