...
knitr::opts_chunk$set(warning = FALSE, message = FALSE) 
include_tikz(image02, name = "image02", markup = "markdown",format = typ, library = c("3d", "babel"), packages=c("tikz","xcolor"),width = "4cm")
```
...
knitr::opts_chunk$set(warning = FALSE, message = FALSE) 
include_tikz(image03, name = "image03", markup = "markdown",format = typ, library = c("3d", "babel"), packages=c("tikz","xcolor"),width = "4cm")
```
...
knitr::opts_chunk$set(warning = FALSE, message = FALSE) 
include_tikz(image04, name = "image04", markup = "markdown",format = typ, library = c("3d", "babel"), packages=c("tikz","xcolor"),width = "4cm")
```
...
knitr::opts_chunk$set(warning = FALSE, message = FALSE) 
include_tikz(image04, name = "image04a", markup = "markdown",format = typ, library = c("3d", "babel"), packages=c("tikz","xcolor"),width = "4cm")
```
...
knitr::opts_chunk$set(warning = FALSE, message = FALSE) 
include_tikz(image02, name = "image02a", markup = "markdown",format = typ, library = c("3d", "babel"), packages=c("tikz","xcolor"),width = "4cm")
```
...
knitr::opts_chunk$set(warning = FALSE, message = FALSE) 
include_tikz(image03, name = "image03a", markup = "markdown",format = typ, library = c("3d", "babel"), packages=c("tikz","xcolor"),width = "4cm")
```
