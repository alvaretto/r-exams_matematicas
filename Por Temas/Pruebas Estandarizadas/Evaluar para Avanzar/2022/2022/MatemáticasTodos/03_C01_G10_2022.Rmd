...
<p align="center">
\centering
```{r image01, warning=FALSE,echo = FALSE, results = "asis",fig.align="center"}
knitr::opts_chunk$set(warning = FALSE, message = FALSE,fig.align="center") 
include_tikz(image01, name = "trepok0q4", markup = "markdown",format = typ,packages = c("venndiagram","tkz-euclide","bm"),width = "10cm")
```
</p>
