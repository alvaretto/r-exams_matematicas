...
========
\
En una bodega hay `r poblasiom` tipos diferentes de botellas. ¿De cuántas formas se pueden elegir `r muesstra` botellas?
...
* ¿Hay repetición? Sí. Se pueden escoger varias botellas del mismo tipo.
...
Por tanto, de las `r poblasiom` botellas diferentes se pueden elegir `r muesstra` de `r rescorr` formas posibles.
