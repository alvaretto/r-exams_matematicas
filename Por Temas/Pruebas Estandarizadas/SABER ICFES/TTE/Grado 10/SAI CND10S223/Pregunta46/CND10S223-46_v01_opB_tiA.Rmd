...
I. `r claves[2]` `r valores[2]`\
II. `r claves[1]` `r valores[5]`\
...
- 
La expresión I, `r opc02` `r valores[2]`
...
La afirmación INCORRECTA es: "II. `r claves[1]` `r valores[5]`"\


Meta-information
================

exname: CND10S223-46_v01_opB_tiA(single-choice)
extype: schoice
exsolution: 0100
exshuffle: FALSE