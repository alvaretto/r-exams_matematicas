...
\\end{center}
'
image03vcr01 <- sprintf(image03vcr01,muesstra,todox,todox,muesstra,rescorr,
                        muesstra,todox,rescorr)
```
Question
========
\
Al girar una ruleta puede salir como resultado cualquier número natural comprendido entre `r limitpob1` y `r limitpob2`, incluidos estos dos números. (Esta ruleta puede tener características diferentes a las tradicionales). Si se gira la ruleta `r muesstra` veces, ¿cuántos resultados pueden obtenerse?
...
```{r image03vcr01, warning=FALSE,echo = FALSE, results = "asis"}
knitr::opts_chunk$set(warning = FALSE, message = FALSE) 
include_tikz(image03vcr01, name = "image03vcr01", markup = "markdown",
