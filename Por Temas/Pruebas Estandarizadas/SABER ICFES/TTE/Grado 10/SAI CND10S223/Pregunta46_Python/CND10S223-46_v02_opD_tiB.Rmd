...
opc01 = genera_opciones(pobl, resultado, numerator1, valores[2])
opc02 = genera_opciones(pobl, resultado2, numerator2, valores[0])
...
II. `r py$claves[2]` `r py$valores[1]`\
III. `r py$claves[3]` `r py$valores[2]`\
IV. `r py$claves[4]` `r py$valores[4]`\
...
La afirmación CORRECTA es: "IV. `r py$claves[4]` `r py$valores[4]`"\


Meta-information
================

exname: CND10S223-46_v02_opD_tiB(single-choice)
extype: schoice
exsolution: 0001
exshuffle: FALSE