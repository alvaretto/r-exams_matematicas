...
========
\
De los `r extudiamtes` estudiantes de un salón debo seleccionar `r eleggidos`, para llevarlos a un almuerzo. ¿De cuántas formas diferentes puedo seleccionar a los `r eleggidos` estudiantes?
...
\
Por tanto, el profesor puede seleccionar a los `r eleggidos` estudiantes de `r rescorr` formas diferentes.
...
Meta-information
================
exname:CombinacionSinRep_01_05(single-choice)
extype:schoice
exsolution: 1000
exshuffle: TRUE