...
\\pgfplotsset{width=7cm,compat=1.17}
	\\begin{tikzpicture}
\\begin{axis}[
title=El Pájaro tiene diarrea,
ymajorgrids,
unbounded coords=discard,
ylabel={Pájaro},
			xlabel={Cantidad de diarrea},
]
\\addplot [line width=1mm, color=green] coordinates {
(0,0) (10,20) (20,40) (30,60)
(40,100) (50,110) (60,100) (80,50)
};
\\end{axis}
\\end{tikzpicture}
\\begin{tikzpicture}
...
\\addplot coordinates {
(0,0) (10,50) (20,100) (30,80)
(40,120) (50,110) (60,100) (80,50)
};
\\end{axis}
\\end{tikzpicture}
'
...
include_tikz(dibujo23, name = "dibujo_23_2", markup = "markdown",format = typ, library = c("3d", "babel"), packages=c("pgfplots","tikz","xcolor"),width = "6cm")
```
...
knitr::opts_chunk$set(warning = FALSE, message = FALSE) 
include_tikz(image23_3, name = "grafik23_3", markup = "markdown",format = typ, library = c("3d", "babel"), packages=c("tikz","xcolor"),width = "6cm")
```
