...
\usepackage{siunitx}
\usepackage{pgfplots}
\usepackage{a4wide,color,verbatim,Sweave,url,xargs,amsmath,tabu,multicol,pgfplots,graphicx,booktabs,subcaption}
...
\usepackage{floatrow}
\usepackage{ragged2e}
\usetikzlibrary{shapes,arrows, chains, matrix, calc, trees, positioning, fit,babel,intersections}
...
\textbf{\large{Saber ICFES Matemáticas \myDate \hfill \\Código de taller: \myID}}

\vspace*{2cm}

\begin{tabular}{p{14cm}}
\textbf{Apellidos y Nombres:} \hrule \\[1.5cm]
\textbf{Grado:} \hrule \\[1.5cm]
