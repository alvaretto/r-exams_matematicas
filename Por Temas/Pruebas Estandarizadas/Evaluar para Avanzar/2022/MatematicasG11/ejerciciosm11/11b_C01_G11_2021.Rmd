...
regular <- sample(c(clientes*porc2-2, clientes*porc2-5),1)
regular2 <- clientes*porc2
malo <- clientes*porc1
...
Además, $\frac{`r porcentaje5`}{100}$ × `r clientes` clientes = `r bue_exce` clientes calificaron como “satisfactorio” el servicio. Por tanto, es verdadero que menos de `r bue_exce2` clientes están satisfechos con el servicio que ofrece la empresa.
