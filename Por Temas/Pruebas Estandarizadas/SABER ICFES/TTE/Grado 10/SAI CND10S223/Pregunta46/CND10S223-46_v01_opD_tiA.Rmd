...
busca_y_asigna <- function(dicci, claves) {
  ...
  if (grepl("un niño es de", key)) {
    patinaje <- "de niños"
    numerator1 <<- (ninos1[1] + ninos1[2] + ninos1[3] + ninos1[4])
  } else if (grepl("una niña es de", key)) {
    patinaje <- "de niñas"
    numerator1 <<- (ninos1[5] + ninos1[6] + ninos1[7] + ninos1[8])
...
# Clave 02
busca_y_asigna <- function(dicci, claves) {
  # Solo revisar la segunda clave en 'claves'
  key <- claves[2]
...
# Clave 03
busca_y_asigna <- function(dicci, claves) {
  # Solo revisar la tercera clave en 'claves'
  key <- claves[3]
...
# Clave 04
busca_y_asigna <- function(dicci, claves) {
  # Solo revisar la cuarta clave en 'claves'
  key <- claves[4]
...
# Crea una lista con las cadenas
lista_cadenas2 <- list(num2_1, num2_2, num2_3, num2_4)
...
# Crea una lista con las cadenas
lista_cadenas3 <- list(num3_1, num3_2, num3_3, num3_4)
...
# Crea una lista con las cadenas
lista_cadenas4 <- list(num4_1, num4_2, num4_3, num4_4)
