## exams ----------------------------------------------------------------------------
setwd("/media/datascience/Bodega/Nubes/2023/Rexams2023/Repositorio/schoice/Schioce_2023/Schoice2023/PorTemas/Los Tres Editores/SAI F- II - Sesión 2/Pregunta27")
library(exams)
library(tinytex)
library(reticulate)
...
examen01 <- rep("3EdSAIFIISesion2P27.Rmd",1)
...
##############################################################################
# set.seed(semilla)
# exams2pdf(examen01,name="3EdSAIFIISesion2P27_",encoding="UTF-8",n=2,
...
###################################################################
set.seed(semilla)
exams2moodle(examen01,n=10,svg=TRUE,name="3EdSAIFIISesion2P27",encoding="UTF-8",
...
####################################################################
# set.seed(semilla)
# exams2moodle(examen01,n=30,svg=TRUE,name="3EdSAIFIISesion2P27",encoding="UTF-8",
