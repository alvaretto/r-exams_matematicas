...
questions[1]<-paste("(Plan local / Minutos de plan local) - (Minutos consumidos enero - Minutos plan local).")
solutions[1]<-FALSE
explanations[1]<-"."

questions[2]<-paste("(Plan local / Minutos de plan local) - (Minutos consumidos diciembre - Minutos plan local).")
solutions[2]<-FALSE
explanations[2]<-"."

questions[3]<-paste("(Plan local / Minutos de plan local) - Consumo adicional / (Minutos consumidos enero - Minutos plan local).")
solutions[3]<-TRUE
explanations[3]<-"."

questions[4]<-paste("(Consumo adicional / Minutos de plan local) - Plan local / (Minutos consumidos enero - Minutos plan local).")
solutions[4]<-FALSE
explanations[4]<-"."
...
\
¿Cuál de las siguientes operaciones matemáticas es la correcta para hallar esta diferencia?
\
