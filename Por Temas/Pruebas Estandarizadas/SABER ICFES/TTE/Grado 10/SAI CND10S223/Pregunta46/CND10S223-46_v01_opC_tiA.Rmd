...
num1_1 <- paste("porque el número total de estudiantes es", pobl, 
              "y la cantidad total", resultado, "es", numerator,"; luego, 
              la probabilidad realmente es")
num1_2 <- paste("porque el número de estudiantes es", pobl, 
                "y la cantidad", resultado, "es", numerator,"; por tanto, 
                la probabilidad es")
num1_3 <- paste("porque el número total de estudiantes es", pobl, 
              "y la cantidad total", resultado, "es", numerator,"; luego, 
              la probabilidad realmente es")
num1_4 <- paste("porque el número de casos", resultado, "es", numerator,", pero, 
                el número de casos totales sigue siendo", pobl)
...
portanto <- sample(c("consiguiente", "tanto"), 1)
portanto
...
num4_3 <- paste("porque el número total de estudiantes es", pobl, 
              "y la cantidad total", resultado4, "es", numerator4, " por consiguiente
              su probabilidad es")
num4_4 <- paste("porque el número de casos", resultado4, "es", numerator4, " por ",portanto, 
              "su probabilidad es")
...
I. `r claves[3]` `r valores[3]`\
II. `r claves[2]` `r valores[2]`\
III. `r claves[1]` `r valores[5]`\
IV. `r claves[4]` `r valores[4]`\
...
- 
La expresión I, `r opc03` `r valores[3]`

- 
La expresión II, `r opc02` `r valores[2]`

- 
La expresión III, `r opc01` `r valores[1]`

- 
La expresión IV, `r opc04` `r valores[4]`


Solution
========

La afirmación INCORRECTA es: "III. `r claves[1]` `r valores[5]`"\


Meta-information
================

exname: CND10S223-46_v01_opC_tiA(single-choice)
extype: schoice
exsolution: 0010
exshuffle: FALSE